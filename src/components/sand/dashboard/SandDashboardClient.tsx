...
export function SandDashboardClient() {
  ...
  return (
    <div className="space-y-8">
      ...
      <FadeInUp delay={0.1}>
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between bg-card border rounded-xl p-5 shadow-sm">
          <div>
          ...
          <div className="flex flex-wrap gap-2 w-full sm:w-auto">
            ...
            <Link href="/sand/trips/new" className="flex-1 sm:flex-none">
              <Button variant="secondary" className="w-full bg-blue-100/50 hover:bg-blue-100 dark:bg-blue-900/20 dark:hover:bg-blue-900/40 text-blue-700 dark:text-blue-400">
                <Navigation className="w-4 h-4 mr-2" />
                {t('actions.addTrip')}
              </Button>
            </Link>
            <Link href="/sand/reports" className="flex-1 sm:flex-none">
              <Button variant="secondary" className="w-full bg-green-100/50 hover:bg-green-100 dark:bg-green-900/20 dark:hover:bg-green-900/40 text-green-700 dark:text-green-400">
      ...
      <StaggerContainer className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        {/* Revenue */}
        <StaggerItem>
          <div className="rounded-xl border bg-card text-card-foreground shadow-sm hover:shadow-md transition-all duration-300 p-6 relative overflow-hidden group h-full">
          ...
          <div className="rounded-xl border bg-card text-card-foreground shadow-sm hover:shadow-md transition-all duration-300 p-6 relative overflow-hidden group h-full">
            ...
            <div className="flex flex-row items-center justify-between pb-2 space-y-0 relative z-10">
              ...
              <div className="h-8 w-8 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center">
                <Ship className="h-4 w-4 text-orange-600 dark:text-orange-400" />
              </div>
            </div>
            <div className="text-3xl font-bold relative z-10">
